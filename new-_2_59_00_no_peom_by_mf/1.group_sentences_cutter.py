    ...
    if len(non_sil_times) > 0:
        ...
        if len(non_sil_times) > 1:
            for t in non_sil_times[1:]:
                if t[0] - non_sil_times_concat[-1][-1] < 5000:
        ...
        for int in non_sil_times:
            ...
            tmpPathName = "TPC/samples/ThePoetsCorner_2_59_00_no_peom_by_mf_{:05}.wav".format(thepoetscorner_samples_counter)
...
remove_sil("ThePoetsCorner_2_59_00_no_peom_by_mf.wav", "ThePoetsCorner_clean_2_59_00_silence-removed.wav")
