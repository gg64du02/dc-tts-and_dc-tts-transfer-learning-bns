...
def remove_sil(path_in, path_out, format="wav"):
    ...
    if len(non_sil_times) > 0:
        ...
        for int in non_sil_times:
            ...
            tmpPathName = "TPC/samples/thepoetscorner_clean_2_59_00_{:05}.wav".format(thepoetscorner_samples_counter)
...
remove_sil("ThePoetsCorner_2_59_00.wav", "ThePoetsCorner_clean_2_59_00_silence-removed.wav")
